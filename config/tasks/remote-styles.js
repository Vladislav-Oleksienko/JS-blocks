...
const sassPaths = project.sourceDirectory + '/' + project.remoteSiteDir + '/' + project.stylesDirectory + '/main.scss'
const autoprefixerSettings = targets.autoprefixer
const cssFileName = project.cssMinFileName
const dest = project.distDirectory + '/' + project.remoteSiteDir + '/' + project.stylesDirectory
